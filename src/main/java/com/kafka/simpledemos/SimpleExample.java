...
public class SimpleExample {
      ...
      public void run(long a_maxReads, String a_topic, int a_partition, List<String> a_seedBrokers, int a_port) throws Exception {
        ...
        if (metadata.leader() == null) {
            ...
            while (a_maxReads > 0) {
                  ...
                  //Reading the Data  Finally we read the data being streamed back and write it out.
     ...
     * Finding Starting Offset for Reads
     Now define where to start reading data. Kafka includes two constants to help, kafka.api.OffsetRequest.EarliestTime()
     finds the beginning of the data in the logs and starts streaming from there, kafka.api.OffsetRequest.LatestTime() will
     only stream new messages. Don’t assume that offset 0 is the beginning offset, since messages age out of the log over time.
     * @param consumer
     * @param topic
     * @param partition
     * @param whichTime
